...
Beatsync is a high-precision web audio player built for multi-device playback. The official app is [mesh-listener.onreder.com](https://www.mesh-listener.onreder.com/).
